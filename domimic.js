...
var _Component = require('./components/img/Component');
...
var Domimic = function () {
  ...
  _createClass(Domimic, [{
    ...
    value: function init() {
      ...
      document.querySelectorAll('[data-domimic-tag]').forEach(function (elm) {
        _this.mimic(elm);
      });
    }
  }, {
    key: 'mimic',
    value: function mimic(elm) {
      if (!elm) {
        return;
      }
      ...
      if (tagName === undefined) {} else if (tagName === 'img') {
...
},{"./Ua":3,"./components/img/Component":4}],3:[function(require,module,exports){
'use strict';
...
var Ua = function Ua() {
  ...
  if (!ua) {} else if (ua.includes('chrome')) {
    browser = 'chrome';
  ...
  if (!ua) {} else if (ua.includes('mac os')) {
    os = 'mac';
...
var Img = function Img(opt) {
  ...
  if (!this.ua) {} else if (this.ua.browser === 'chrome') {
    var tmpl = '\n<span class="domimic__img__appearance"></span>\n';
    var compiled = _lodash2.default.template(tmpl);
